  ...
  education: [
    {
      ...
      specialization: 'Економіка підприємства (Магістр)',
  ...
  education: [
    {
      ...
      specialization: 'Экономика предприятия (Магистр)',
  ...
  education: [
    {
      ...
      specialization: 'Enterprise economy (Master)',
...
const myEducationTranslations = {
  ua,
  en,
  ru,
};

export default myEducationTranslations;
